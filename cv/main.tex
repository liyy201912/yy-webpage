...
(i)~\textbf{Efficient AI}---neural network quantization, pruning, architecture search, distillation, and algorithm-hardware co-design; landing deep learning applications on edge devices.
(ii)~\textbf{Computer Vision \& Generative Models}---generative models (diffusion for image and video generation), vision transformers, and on-device mobile AI deployment.
...
\cventry{Northeastern University}{Boston, MA}{Ph.D.\ Research Assistant}{Sep 2019 -- Present}
Research on efficient AI techniques: deep neural network design, quantization, pruning, architecture search, and distillation. Vision models (CNNs and vision transformers) for image recognition, detection, and segmentation. Generative models (GAN and denoising diffusion) for image and video generation.

\cventry{Snap Inc.}{Santa Monica, CA}{Research Intern (Part-time)}{Sep 2022 -- Present}
Architecture optimization and step distillation of large-scale text-to-image Stable Diffusion, quality improvements for text models, and reward fine-tuning techniques. Democratizing content creation by bringing powerful and fast text-to-image diffusion models to a broader audience. Publications at NeurIPS 2023 and CVPR 2024; US patent filed.

\cventry{Snap Inc.}{Santa Monica, CA}{Research Intern (Full-time)}{May 2022 -- Sep 2022}
Efficient Vision Transformers for mobile deployment, enabling ultra-fast image recognition on mobile phones (1\,ms latency) with high accuracy. Publications at NeurIPS 2022 and ICCV 2023; US patent filed.

\cventry{CoCoPIE LLC.}{Newton, MA}{Research Intern (Full-time)}{Jun 2021 -- Aug 2021}
Algorithm-hardware co-design for deep neural network compression and deployment of quantized DNNs on mobile devices.

\cventry{Kuaishou Technology US R\&D}{Palo Alto, CA}{Research Intern (Full-time)}{Sep 2020 -- Jan 2021}
GAN compression and dynamic neural network pruning.
